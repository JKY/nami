...
var SEED = "0123456789abcdefghijkmlnopqrstuvwxyz";
...
var parse_form = exports.parse_form = function(req,resp,func){
    ...
    form.onPart = function(part){
        ...
        part.on("end",function(){
            form.emit('file', part.name, { partname:part.name, name: part.filename, 
...
exports.out = {
  ...
  image:function(resp,type,data){
    var name = new Date().getTime() + ".jpg";
    var content = "inline; filename=\"" + name + "\"";
    resp.writeHead(200, {'Content-Type': type,"Content-Disposition": content});
